	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="sijixingming" placeholder="司机姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="chepaihaoma" placeholder="车牌号码" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "huochesiji/register";
				$.ajax({ 
					type: "POST",
					url: url,

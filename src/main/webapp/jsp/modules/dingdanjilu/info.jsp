						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="yonghuliuyan" name="yonghuliuyan" class="form-control" v-model="ruleForm.yonghuliuyan" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>司机姓名</label>
									...
									<input id="huocheleixing" name="huocheleixing" class="form-control" v-model="ruleForm.huocheleixing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>车牌号码</label>
									...
									<input id="yunshuzhuangtai" name="yunshuzhuangtai" class="form-control" v-model="ruleForm.yunshuzhuangtai" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户名</label>

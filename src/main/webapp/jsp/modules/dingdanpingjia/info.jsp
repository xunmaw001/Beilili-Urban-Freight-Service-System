...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="dingdanpingfen" name="dingdanpingfen" class="form-control" v-model="ruleForm.dingdanpingfen" readonly>
									</div>
									...
									<div class="form-group  col-md-12">
										<label>留言建议</label>
										<script id="liuyanjianyiEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var liuyanjianyiUe = UE.getEditor('liuyanjianyiEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="liuyanjianyi" id="liuyanjianyi-input">
									</div>
									<div class="form-group  col-md-12">
										<label>审核回复</label>
	...
	<script>
		...
		function setContent(){
			...
			if(ruleForm.liuyanjianyi != null && ruleForm.liuyanjianyi != 'null' && ruleForm.liuyanjianyi != ''){
				var mes = '' + ruleForm.liuyanjianyi;
				var liuyanjianyiUeditor = UE.getEditor('liuyanjianyiEditor');
				liuyanjianyiUeditor.ready(function() {
					liuyanjianyiUeditor.setContent(mes);
					liuyanjianyiUeditor.setDisabled('fullscreen');
				});
			}

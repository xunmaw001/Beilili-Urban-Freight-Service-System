...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="dingdanpingfen" id="dingdanpingfenSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
										<option value="★">★</option>
										<option value="★★">★★</option>
										<option value="★★★">★★★</option>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('dingdanpingfen')">订单评分<i id="dingdanpingfenIcon" class="fa fa-sort"></i></th>
											<th>评价内容</th>
											<th>留言建议</th>
	...
	<script>
		...
		function search(){
			...
			var dingdanpingfenIndex = document.getElementById("dingdanpingfenSelect").selectedIndex;
			var dingdanpingfenOptions = document.getElementById("dingdanpingfenSelect").options;
			var dingdanpingfenSelectedOption = dingdanpingfenOptions[dingdanpingfenIndex]
			if(dingdanpingfenSelectedOption.text != null && dingdanpingfenSelectedOption.text != ''){
				searchForm.dingdanpingfen = dingdanpingfenSelectedOption.text;
			}
        ...
        function getDataList() {
			http("dingdanpingjia/page","GET",{
				...
				dingdanpingfen : searchForm.dingdanpingfen,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var dingdanpingfenCell  = document.createElement('td');

						 dingdanpingfenCell.innerHTML = item.dingdanpingfen;

			row.appendChild(dingdanpingfenCell);
			...
			var liuyanjianyiCell  = document.createElement('td');

						  if(item.liuyanjianyi != null && item.liuyanjianyi != "" && item.liuyanjianyi.length >= 11){
			  	liuyanjianyiCell.innerHTML = item.liuyanjianyi.substring(0, 10) + "..."; 
			  }else{
			  	liuyanjianyiCell.innerHTML = item.liuyanjianyi;
			  }


			row.appendChild(liuyanjianyiCell);
